    ...
    for (const person of people) {
      ...
      try {
        ...
        if (enrichData.person?.email) {
          ...
          console.log('Got email for:', person.first_name, person.last_name, '|', enrichData.person.email);
        } else {
          console.log('No email found for:', person.first_name, person.last_name);
        }
      } catch(err) {
        console.log('Enrich error for', person.first_name, ':', err.message);
      }
